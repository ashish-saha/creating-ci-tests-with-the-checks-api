...
class GHAapp < Sinatra::Application
  ...
  helpers do
    ...
    def take_requested_action
      ...
      if (@payload['requested_action']['identifier'] == 'fix_rubocop_notices')
        ...
        begin
          ...
          @git.push("https://x-access-token:#{@installation_token.to_s}@github.ibm.com/#{full_repo_name}.git", head_branch)
        rescue
          # Nothing to commit!
    ...
    def clone_repository(full_repo_name, repository, ref)
      @git = Git.clone("https://x-access-token:#{@installation_token.to_s}@github.ibm.com/#{full_repo_name}.git", repository)
      pwd = Dir.getwd()
      Dir.chdir(repository)
      @git.pull
      @git.checkout(ref)
